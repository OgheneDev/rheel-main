...
const Testimonials = () => {
  return (
    <section className="md:px-[130px] py-8 px-5 md:py-15 bg-[#F3F7FD]">
        <article className="text-center mb-7 px-12">
            <span className="uppercase text-[#0A2F1E] text-[13px]">Our Testimonials</span>
            <h2 className="text-3xl font-bold text-[#161E2D] mb-5">What’s people say’s</h2>
