...
const AboutUs = () => {
  return (
    <div className='flex flex-col lg:flex-row gap-5 lg:gap-14 justify-between items-stretch py-10 lg:py-20 max-w-7xl mx-auto lg:px-8'>
      <div className="text-container  lg:w-5/12 flex flex-col">
        <div>
          <h3 className='uppercase font-bold text-xl mb-4'>ABOUT US</h3>
          <div className="space-y-4">
            <p className='text-base leading-7 lg:leading-8'>
      ...
      <div className="image-container lg:w-6/12 h-auto">
