...
const OurStory = () => {
  return (
    <div className='flex flex-col gap-8 lg:flex-row w-full max-w-7xl mb-5 lg:mb-0 mx-auto lg:px-8 lg:pb-15'>
      <div className="image-container w-full lg:w-1/2 h-full">
      ...
      <div className="text-container w-full lg:w-1/2 flex flex-col">
        <h3 className='uppercase font-bold text-xl mb-6'>Our Story</h3>
        <div className="space-y-6">
          <p className='text-base leading-relaxed lg:leading-8'>
