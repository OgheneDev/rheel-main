...
const MissionAndVision = () => {
  return (
    <div className="flex flex-col md:flex-row gap-5 md:gap-10 justify-center items-center  pb-10">
        <div className="vision space-y-5 flex-1">
