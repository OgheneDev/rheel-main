...
const HeroSection = () => {
  return (
    <section className="bg-[url('/images/hero-bg.jpg')] bg-cover bg-center h-screen bg-blend-overlay bg-black/40 text-white px-7 md:px-[130px] py-15 md:pt-30 text-center">
