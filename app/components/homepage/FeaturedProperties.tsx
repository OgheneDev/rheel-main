...
// Modified FeaturedProperties.tsx
const FeaturedProperties = () => {
  ...
  return (
    <section
      ...
      className="container mx-auto px-5 py-10 md:py-15"
    >
      <motion.article variants={containerVariants} className="text-center mb-7">
        <motion.span
          ...
          className="uppercase text-[#0A2F1E] text-[12px]"
        >
          Featured Properties
        </motion.span>
        <motion.h2
          ...
          className="text-2xl font-bold text-[#161E2D]"
        >
          Recommended for you
        </motion.h2>
      </motion.article>
